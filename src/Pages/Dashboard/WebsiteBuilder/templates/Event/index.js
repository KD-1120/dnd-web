        ...
        components: [
          ...
          },
          {
            ...
            props: {
              ...
              eventOngoingTitle: 'Event In Progress',
              eventOngoingSubtitle: 'Time remaining until the event concludes',
              eventEndedTitle: 'Event Has Ended',
              eventEndedSubtitle: 'Thank you for your interest. See you at our next event!',
              ...
              headerSpacing: '24px',
              showEventInfo: true,
              eventInfoFontSize: '16px',
              eventInfoSpacing: '24px',
              ...
              showDividers: true,
              dividerFontSize: '24px',
              dividerColor: '#D1D5DB',
              dividerPadding: '0 4px',
              showActionButton: true,
              actionButtonText: 'Get Your Tickets Now',
              actionButtonUrl: '#tickets-section',
              eventOngoingButtonText: 'Join Now',
              eventOngoingButtonUrl: '#',
              eventEndedButtonText: 'View Recordings',
              eventEndedButtonUrl: '#',
