              ...
              <Col md={6}>
                <CapabilityItem>
                  ...
                  <div>
                    ...
                    <FeatureDescription>
                      Monitor ticket sales, registrations, and attendance as they happen
                    </FeatureDescription>
                  </div>
                </CapabilityItem>
              </Col>
              <Col md={6}>
                <CapabilityItem>
                  ...
                  <div>
                    ...
                    <FeatureDescription>
                      Track poll responses, Q&A participation, and session interactions
                    </FeatureDescription>
                  </div>
                </CapabilityItem>
              </Col>
              <Col md={6}>
                <CapabilityItem>
                  ...
                  <div>
                    ...
                    <FeatureDescription>
                      See how your marketing efforts drive ticket sales
                    </FeatureDescription>
                  </div>
                </CapabilityItem>
              </Col>
              <Col md={6}>
                <CapabilityItem>
                  ...
                  <div>
                    ...
                    <FeatureDescription>
                      Export data for deeper analysis and strategic planning
                    </FeatureDescription>
                  </div>
                </CapabilityItem>
              </Col>
