              ...
              <Col md={6}>
                <CapabilityItem>
                  ...
                  <div>
                    ...
                    <FeatureDescription>
                      Customize URLs for easy sharing and brand recognition
                    </FeatureDescription>
                  </div>
                </CapabilityItem>
              </Col>
              <Col md={6}>
                <CapabilityItem>
                  ...
                  <div>
                    ...
                    <FeatureDescription>
                      Instantly create QR codes linked to your event page
                    </FeatureDescription>
                  </div>
                </CapabilityItem>
              </Col>
              <Col md={6}>
                <CapabilityItem>
                  ...
                  <div>
                    ...
                    <FeatureDescription>
                      Share effortlessly on Facebook, Instagram, LinkedIn, and more
                    </FeatureDescription>
                  </div>
                </CapabilityItem>
              </Col>
              <Col md={6}>
                <CapabilityItem>
                  ...
                  <div>
                    ...
                    <FeatureDescription>
                      Update links dynamically without breaking access
                    </FeatureDescription>
                  </div>
                </CapabilityItem>
              </Col>
