              ...
              <Col md={6}>
                <CapabilityItem>
                  ...
                  <div>
                    ...
                    <FeatureDescription>
                      Optimized for speed, even on slower networks
                    </FeatureDescription>
                  </div>
                </CapabilityItem>
              </Col>
              <Col md={6}>
                <CapabilityItem>
                  ...
                  <div>
                    ...
                    <FeatureDescription>
                      Easy scrolling, tapping, and swiping for mobile users
                    </FeatureDescription>
                  </div>
                </CapabilityItem>
              </Col>
              <Col md={6}>
                <CapabilityItem>
                  ...
                  <div>
                    ...
                    <FeatureDescription>
                      Attendees can buy tickets and check in with their phones
                    </FeatureDescription>
                  </div>
                </CapabilityItem>
              </Col>
